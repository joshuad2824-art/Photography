...
## State management & data (prototype today — needs real backend)
Everything here is a client-side demo, not a real data layer:
...
- `screenshots/` — 01 home, 02 galleries index, 03 album detail, 04 session locked, 05 session unlocked, 06 about.
